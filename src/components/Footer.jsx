...
const Footer = () => {
  return (
    <div className='w-full mt24 bg-gray-900 text-gray-300 py-2 px-2'>
      <div
        ...
        <div className='col-span-2 py-8 md:pt-2'>
          ...
          <p className='py-4'>The latest deals, articles and resources sent to our inbox weekly</p>
      ...
      <div className='flex flex-col max-w-[1400px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500'>
        <p className='py-4'>2022 Experiences, LCC, All rights reserved</p>
